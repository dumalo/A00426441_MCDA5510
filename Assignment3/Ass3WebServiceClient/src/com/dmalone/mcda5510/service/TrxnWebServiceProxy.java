...
public class TrxnWebServiceProxy implements com.dmalone.mcda5510.service.TrxnWebService {
  private String _endpoint = null;
  private com.dmalone.mcda5510.service.TrxnWebService trxnWebService = null;
  ...
  private void _initTrxnWebServiceProxy() {
    try {
      trxnWebService = (new com.dmalone.mcda5510.service.TrxnWebServiceServiceLocator()).getTrxnWebService();
  ...
  public com.dmalone.mcda5510.service.TrxnWebService getTrxnWebService() {
    if (trxnWebService == null)
      _initTrxnWebServiceProxy();
    return trxnWebService;
  }
  
  public float addFloat(float f) throws java.rmi.RemoteException{
    if (trxnWebService == null)
      _initTrxnWebServiceProxy();
    return trxnWebService.addFloat(f);
  }
  
  public com.dmalone.mcda5510.entity.Transaction getTransaction(int trxnID) throws java.rmi.RemoteException{
    if (trxnWebService == null)
      _initTrxnWebServiceProxy();
